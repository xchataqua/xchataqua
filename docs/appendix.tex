...
(hoffentlich richtigen) etwas zusammen. Er ist für die Webseite zuständig und
...
Jede Veränderung im ChangeLog ohne Namen ist sein Werk. Seine Email Adresse
...
den XChat gebrauchen, schau Dir als erstes dieses Dokument an, dann frag
jemanden im Elitenet\footnote{Server: irc.xchat.org} (\#linux), aber denke
daran, daß die Leute in \#linux nicht irgendwelchen Schrott unterstützen. Sie
...
Texte erstellt. Bitte denkt daran, daß die Dokumentation sehr groß ist und wir
nicht sehr viel Zeit haben,um uns ellenlange Text durchzulesen, worin vermerkt
ist, daß in Zeilennummer ``sowieso'' ein Fehler verborgen ist. \textbf{Bitte
  denkt daran, daß ihr euch für die entsprechenden Sprachen an die
...
\chapter{Übersicht der Tastaturkürzel im XChat 2}
