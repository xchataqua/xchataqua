...
\item Doppelklick-Kommando - Das Kommando wird ausgeführt, wenn man auf einen Benutzer in der Benutzerliste doppelt klickt. \%s in der Option wird mit dem Spitznamen ersetzt, bevor es ausgeführt wird.
\end{itemize}

\subsection{IRC Eingabe/Ausgabe}\label{irc_ein_ausgabe}
\begin{description}
\item[Vervollständigen der Spitznamen] - Durch Setzen wird der eingegebene Text nach falschen Spitznamen durchsucht und berichtigt. Siehe auch Tab Spitznamen.
\item[Zeitmarkierung für gesamten Text] - Hier wird vor jeder neuen Zeile die Uhrzeit mit ausgedruckt.
...
\item[Textpuffer-Größe] - Die Nummer von Zeilen, welche gepuffert werden (0 = alle Zeilen).
...
\item[Benutzerlisten-Knöpfe] - Wenn das angeklickt ist, werden die Kommando-Knöpfe unter der Benutzerliste angezeigt.
...
Diese Indikatoren geben Dir über die Verbindung zum Server Auskunft.
...
\begin{description}
\item[Schriftart] - Die Schrift, die für den Standardtext benutzt wird.
\item[Fettschrift] - Die Schrift, die für Fettschrift benutzt wird.
\item[Hintergrundbild] - Ein Bild, das im Hintergrund des Textkästchens angezeigt wird.
...
\item[Proxy Typ] - Man kann zwischen Wingate, Socks4, Socks5 und einem HTTP Proxy auswählen.
\end{description}
