...
kennen gelernt hat, möchte nicht unbedingt die ganze Dokumentation wälzen um an
...
sollte man auf Seite \pageref{bekommen_starten} unter (\ref{bekommen_starten})
  ...
  Gestartet wird der XChat durch das Kommando \verb|xchat-gnome|\footnote{In manchen Distributionen wie Debian
    heißt die ausführbare Datei xchat-gnome. Abhängig ist dies vom Hersteller
    des Paketes für die Distribution.} oder allgemein \verb|xchat|.
