...
BASE_LOCALE='en'
IBTOOL_FLAGS="--plugin-dir '$BUILD_DIR/$CONFIGURATION$EFFECTIVE_PLATFORM_NAME' --plugin-dir '$PROJECT_DIR/$TARGET_PLATFORM/IBPlugins'"
...
MO_BASE_DIR="$PROJECT_DIR/$TARGET_PLATFORM/Resources/locale"
