...
- (void) setVJustification:(SGVBoxVJustification) just;
- (void) setDefaultHJustification:(SGVBoxHJustification) just;
- (short) hJustification;
- (void) setHJustificationFor:(NSView *) view to:(SGVBoxHJustification) just;
