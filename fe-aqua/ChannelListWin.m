...
- (NSComparisonResult) sortByChannel:(ChannelEntry *)other;
- (NSComparisonResult) sortByNumberOfUsers:(ChannelEntry *)other;
- (NSComparisonResult) sortByTopic:(ChannelEntry *)other;
- (NSComparisonResult) sortByChannelReverse:(ChannelEntry *)other;
- (NSComparisonResult) sortByNumberOfUsersReverse:(ChannelEntry *)other;
- (NSComparisonResult) sortByTopicReverse:(ChannelEntry *)other;
...
{
	ChannelEntry *entry = [[[ChannelEntry alloc] init] autorelease];
...
- (void) doJoin:(id) sender
{
	...
	ChannelEntry *entry = [items objectAtIndex:row];
